...
If the NVRAM index `0x01c00002` is already defined, the tool will notify you and skip the write step to prevent errors. To force a overwrite, you must clear the TPM state (e.g., delete the simulator's `NVChip` file and restart it).
